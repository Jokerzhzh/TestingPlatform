<template>
    <div>
        ...
        <el-card class="box-card">
            ...
            <h4 style="color:#909399;line-height:40px;text-align:center;">缺陷处理人/状态分布图</h4>-->
            ...
            <el-table :data="tableData" border size="mini" class="table" ref="multipleTable">
                <el-table-column prop="owner" label="Bug归属人" align="center">
                    <template slot-scope="scope">{{ scope.row.owner }}</template>
                </el-table-column>
                <el-table-column label="总数">
                    <template slot-scope="scope">{{ scope.row.sum_bugs }}</template>
                </el-table-column>
                <el-table-column prop="Closed" label="已关闭的bug数">
                    <template slot-scope="scope">{{ scope.row.Closed }}</template>
                </el-table-column>
                <el-table-column label="处理中的bug数量">
                    <template slot-scope="scope">{{ scope.row.In_Progress }}</template>
                </el-table-column>
                <el-table-column label="重新打开的bug数量">
                    <template slot-scope="scope">{{ scope.row.Reopened }}</template>
                </el-table-column>
                <el-table-column label="已解决的bug数量">
                    <template slot-scope="scope">{{ scope.row.Resolved }}</template>
                </el-table-column>
                <el-table-column label="刚创建的bug数量">
